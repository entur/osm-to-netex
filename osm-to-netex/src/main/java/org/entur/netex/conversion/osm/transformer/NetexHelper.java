...
public class NetexHelper {
    ...
    public PublicationDeliveryStructure createPublicationDelivery(SiteFrame siteFrame, String participantRef) {
    ...
    private String generatePublicationDeliveryDescription() {
        return String.format("Generated by osm-to-netex on host : '%s'. Tool: https://github.com/entur/osm-to-netex", hostname());
    }
